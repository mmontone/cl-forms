...
(hunchentoot:define-easy-handler (demo-renderers :uri "/renderers") ()
  (flet ((render ()
		 ...
		 (forms:render-form-end))
	       ...
	       (who:str (djula:render-template* (asdf:system-relative-pathname :cl-forms.demo "test/demo/djula-form.html") nil :form (get-form 'fields-form)))
	       (:h2 "Djula by part")
	       (:p (who:str "Render a form with a Djula template, by parts."))
	       (who:str (djula:render-template* (asdf:system-relative-pathname :cl-forms.demo "test/demo/djula-form-parts.html") nil :form (get-form 'fields-form)))
               ))))
